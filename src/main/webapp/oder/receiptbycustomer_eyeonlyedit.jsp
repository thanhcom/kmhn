...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <h1 class="center_sun4">Kính Mắt Hà  Nội CS2 :<span class="badge rounded-pill text-bg-warning">Sửa Phần Đo Mắt - ${customer.getName()}</span> </h1>
            <div class="row">
                <div class="col"></div>
                <div class="col">
                    <form action="receiptbycustomer_eyeonlyeditsave" method="post">
                        <div class="form-group row">
                            <input type="hidden" name="cid" value="${customer.getId()}"/>
                            <input type="hidden" name="eid" value="${eyeservice.eyeid}"/>
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="SPHR" class="form-control" placeholder="SPHR" aria-label="Username" aria-describedby="basic-addon1" value="${eyeservice.eyesphr}" required>
                            <input type="text" name="CYLR" class="form-control" placeholder="CYLR" aria-label="Username" aria-describedby="basic-addon1" value="${eyeservice.eyecylr}" required>
                            <input type="text" name="AXR" class="form-control" placeholder="AXR" aria-label="Username" aria-describedby="basic-addon1" value="${eyeservice.eyeaxr}" required>
                            <input type="text" name="ADD" class="form-control" placeholder="ADD" aria-label="Username" aria-describedby="basic-addon1"  value="${eyeservice.eyeadd}"required>
                        </div>
                        <div class="input-group mb-3">
                            <input type="text" name="SPHL" class="form-control" placeholder="SPHL" aria-label="Username" aria-describedby="basic-addon1" value="${eyeservice.eyesphl}" required>
                            <input type="text" name="CYLL" class="form-control" placeholder="CYLL" aria-label="Username" aria-describedby="basic-addon1" value="${eyeservice.eyecyll}" required>
                            <input type="text" name="AXL" class="form-control" placeholder="AXL" aria-label="Username" aria-describedby="basic-addon1" value="${eyeservice.eyeaxl}" required>
                            <input type="text" name="PD" class="form-control" placeholder="PD" aria-label="Username" aria-describedby="basic-addon1" value="${eyeservice.eyepd}" required>
                            
                        </div>
                        <div class="input-group mb-3">
                            <input type="text" name="approved" class="form-control" placeholder="Đáp Ứng " aria-label="Username" aria-describedby="basic-addon1" value="${eyeservice.eyeapproved}" >
                        </div>
                        <hr/>
                        <div class="form-group row">
                            <div class="col-sm-10">
