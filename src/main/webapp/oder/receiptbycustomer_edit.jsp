...
<html>
    ...
    <body>
        ...
        <div class="container-fluid">
            <h1 class="center_sun4">Kính Mắt Hà  Nội CS2 :<span class="badge rounded-pill text-bg-warning">Sửa Đơn Kính - ${customer.getName()}</span> </h1>
            <div class="row">
                <div class="col"></div>
                <div class="col">
                    <form action="receiptbycustomer_editsave" method="post">
                        <div class="form-group row">
                            <input type="hidden" name="cid" value="${customer.getId()}"/>
                            <input type="hidden" name="rid" value="${receipt.id}"/>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" name="phone" class="form-control" value="${customer.getPhone()}" >
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="number" name="age" class="form-control"  value="${customer.getAge()}"  required>
                            </div>
                        </div>
                        ...
                        <div class="input-group mb-3">
                            <input type="text" name="gkname" class="form-control" placeholder="Tên Gọng " aria-label="Username" aria-describedby="basic-addon1" value="${receipt.gkName}">
                            <input type="text" name="gkprice" class="form-control" placeholder="Giá Tiền " aria-label="Username" aria-describedby="basic-addon1" value="${receipt.gkPrice}" required>
                            <input type="text" name="tkname" class="form-control" placeholder="Tên Tròng" aria-label="Username" aria-describedby="basic-addon1" value="${receipt.tkName}">
                            <input type="text" name="tkprice" class="form-control" placeholder="Giá Tiền"  aria-label="Username" aria-describedby="basic-addon1" value="${receipt.tkPrice}" required>
                        </div>
                        <div class="input-group mb-4">
                            <input type="text" name="note" class="form-control" placeholder="Ghi Chú " aria-label="Username" aria-describedby="basic-addon1" value="${receipt.note}">
                            <input type="text" name="discount" class="form-control" placeholder="Khuyến Mại %" aria-label="Username" aria-describedby="basic-addon1" value="${receipt.discount}" required>
                        <select name="paymentmethod" class="form-select form-select-sm" aria-label="Small select example" id="validationDefault04" required>
                            ...
                            <c:if test="${receipt.getPaymentMethod()==0}">
                                <option value="0" selected>Tiền Mặt</option>
                                <option value="1">Chuyển Khoản</option>
                            </c:if> 
                            <c:if test="${receipt.getPaymentMethod()==1}">
